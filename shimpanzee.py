...
class ShimSim(object):
    ...
    def startGame(self):
        self.z1Game = np.random.uniform(-Z1LIM, Z1LIM, 1)[0]
        self.z2Game = np.random.uniform(-Z2LIM, Z2LIM, 1)[0]
        self.z3Game = np.random.uniform(-Z3LIM, Z3LIM, 1)[0]
        self.x1Game = np.random.uniform(-X1LIM, X1LIM, 1)[0]
        self.y1Game = np.random.uniform(-Y1LIM, Y1LIM, 1)[0]
        self.xzGame = np.random.uniform(-XZLIM, XZLIM, 1)[0]
        self.xyGame = np.random.uniform(-XYLIM, XYLIM, 1)[0]
        self.yzGame = np.random.uniform(-YZLIM, YZLIM, 1)[0]
        self.x2_y2Game = np.random.uniform(-X2_Y2LIM, X2_Y2LIM, 1)[0]
        self.z4Game = np.random.uniform(-Z4LIM, Z4LIM, 1)[0]
        self.z5Game = np.random.uniform(-Z5LIM, Z5LIM, 1)[0]
...
class ShimFrame(QtWidgets.QScrollArea):
    ...
    def __init__(self, parent):
        ...
        self.grid.addWidget(QtWidgets.QLabel("Z:"), 2, 0)
        self.z1 = QtWidgets.QLineEdit(self)
        self.z1.setAlignment(QtCore.Qt.AlignHCenter)
        self.z1.setText("0.0")
        self.z1.returnPressed.connect(lambda: self.insertVal(self.z1, self.z1Scale, 1000/Z1LIM))
        self.grid.addWidget(self.z1, 3, 0)
        self.z1Scale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.z1Scale.setRange(-1000, 1000)
        self.z1Scale.valueChanged.connect(lambda inp: self.setVal(inp, self.z1, 1000/Z1LIM))
        self.grid.addWidget(self.z1Scale, 4, 0)

        self.grid.addWidget(QtWidgets.QLabel("Z2:"), 5, 0)
        self.z2 = QtWidgets.QLineEdit(self)
        self.z2.setAlignment(QtCore.Qt.AlignHCenter)
        self.z2.setText("0.0")
        self.z2.returnPressed.connect(lambda: self.insertVal(self.z2, self.z2Scale, 1000/Z2LIM))
        self.grid.addWidget(self.z2, 6, 0)
        self.z2Scale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.z2Scale.setRange(-1000, 1000)
        self.z2Scale.valueChanged.connect(lambda inp: self.setVal(inp, self.z2, 1000/Z2LIM))
        self.grid.addWidget(self.z2Scale, 7, 0)

        self.grid.addWidget(QtWidgets.QLabel("Z3:"), 8, 0)
        self.z3 = QtWidgets.QLineEdit(self)
        self.z3.setAlignment(QtCore.Qt.AlignHCenter)
        self.z3.setText("0.0")
        self.z3.returnPressed.connect(lambda: self.insertVal(self.z3, self.z3Scale, 1000/Z3LIM))
        self.grid.addWidget(self.z3, 9, 0)
        self.z3Scale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.z3Scale.setRange(-1000, 1000)
        self.z3Scale.valueChanged.connect(lambda inp: self.setVal(inp, self.z3, 1000/Z3LIM))
        self.grid.addWidget(self.z3Scale, 10, 0)
        
        self.grid.addWidget(QtWidgets.QLabel("X:"), 2, 1)
        self.x1 = QtWidgets.QLineEdit(self)
        self.x1.setAlignment(QtCore.Qt.AlignHCenter)
        self.x1.setText("0.0")
        self.x1.returnPressed.connect(lambda: self.insertVal(self.x1, self.x1Scale, 1000/X1LIM))
        self.grid.addWidget(self.x1, 3, 1)
        self.x1Scale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.x1Scale.setRange(-1000, 1000)
        self.x1Scale.valueChanged.connect(lambda inp: self.setVal(inp, self.x1, 1000/X1LIM))
        self.grid.addWidget(self.x1Scale, 4, 1)

        self.grid.addWidget(QtWidgets.QLabel("Y:"), 5, 1)
        self.y1 = QtWidgets.QLineEdit(self)
        self.y1.setAlignment(QtCore.Qt.AlignHCenter)
        self.y1.setText("0.0")
        self.y1.returnPressed.connect(lambda: self.insertVal(self.y1, self.y1Scale, 1000/Y1LIM))
        self.grid.addWidget(self.y1, 6, 1)
        self.y1Scale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.y1Scale.setRange(-1000, 1000)
        self.y1Scale.valueChanged.connect(lambda inp: self.setVal(inp, self.y1, 1000/Y1LIM))
        self.grid.addWidget(self.y1Scale, 7, 1)

        self.grid.addWidget(QtWidgets.QLabel("XZ:"), 2, 2)
        self.xz = QtWidgets.QLineEdit(self)
        self.xz.setAlignment(QtCore.Qt.AlignHCenter)
        self.xz.setText("0.0")
        self.xz.returnPressed.connect(lambda: self.insertVal(self.xz, self.xzScale, 1000/XZLIM))
        self.grid.addWidget(self.xz, 3, 2)
        self.xzScale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.xzScale.setRange(-1000, 1000)
        self.xzScale.valueChanged.connect(lambda inp: self.setVal(inp, self.xz, 1000/XZLIM))
        self.grid.addWidget(self.xzScale, 4, 2)

        self.grid.addWidget(QtWidgets.QLabel("XY:"), 5, 2)
        self.xy = QtWidgets.QLineEdit(self)
        self.xy.setAlignment(QtCore.Qt.AlignHCenter)
        self.xy.setText("0.0")
        self.xy.returnPressed.connect(lambda: self.insertVal(self.xy, self.xyScale, 1000/XYLIM))
        self.grid.addWidget(self.xy, 6, 2)
        self.xyScale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.xyScale.setRange(-1000, 1000)
        self.xyScale.valueChanged.connect(lambda inp: self.setVal(inp, self.xy, 1000/XYLIM))
        self.grid.addWidget(self.xyScale, 7, 2)

        self.grid.addWidget(QtWidgets.QLabel("YZ:"), 8, 2)
        self.yz = QtWidgets.QLineEdit(self)
        self.yz.setAlignment(QtCore.Qt.AlignHCenter)
        self.yz.setText("0.0")
        self.yz.returnPressed.connect(lambda: self.insertVal(self.yz, self.yzScale, 1000/YZLIM))
        self.grid.addWidget(self.yz, 9, 2)
        self.yzScale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.yzScale.setRange(-1000, 1000)
        self.yzScale.valueChanged.connect(lambda inp: self.setVal(inp, self.yz, 1000/YZLIM))
        self.grid.addWidget(self.yzScale, 10, 2)
        
        self.grid.addWidget(QtWidgets.QLabel("X2-Y2:"), 11, 2)
        self.x2_y2 = QtWidgets.QLineEdit(self)
        self.x2_y2.setAlignment(QtCore.Qt.AlignHCenter)
        self.x2_y2.setText("0.0")
        self.x2_y2.returnPressed.connect(lambda: self.insertVal(self.x2_y2, self.x2_y2Scale, 1000/X2_Y2LIM))
        self.grid.addWidget(self.x2_y2, 12, 2)
        self.x2_y2Scale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.x2_y2Scale.setRange(-1000, 1000)
        self.x2_y2Scale.valueChanged.connect(lambda inp: self.setVal(inp, self.x2_y2, 1000/X2_Y2LIM))
        self.grid.addWidget(self.x2_y2Scale, 13, 2)

        self.grid.addWidget(QtWidgets.QLabel("z4:"), 11, 0)
        self.z4 = QtWidgets.QLineEdit(self)
        self.z4.setAlignment(QtCore.Qt.AlignHCenter)
        self.z4.setText("0.0")
        self.z4.returnPressed.connect(lambda: self.insertVal(self.z4, self.z4Scale, 1000/Z4LIM))
        self.grid.addWidget(self.z4, 12, 0)
        self.z4Scale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.z4Scale.setRange(-1000, 1000)
        self.z4Scale.valueChanged.connect(lambda inp: self.setVal(inp, self.z4, 1000/Z4LIM))
        self.grid.addWidget(self.z4Scale, 13, 0)

        self.grid.addWidget(QtWidgets.QLabel("z5:"), 14, 0)
        self.z5 = QtWidgets.QLineEdit(self)
        self.z5.setAlignment(QtCore.Qt.AlignHCenter)
        self.z5.setText("0.0")
        self.z5.returnPressed.connect(lambda: self.insertVal(self.z5, self.z5Scale, 1000/Z5LIM))
        self.grid.addWidget(self.z5, 15, 0)
        self.z5Scale = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.z5Scale.setRange(-1000, 1000)
        self.z5Scale.valueChanged.connect(lambda inp: self.setVal(inp, self.z5, 1000/Z5LIM))
